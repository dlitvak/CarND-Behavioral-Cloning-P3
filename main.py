...
sap = SteeringAnglePredictor(img_shape=img_shape, model_file="lenet_cumul_more_dropout.h5", epochs=EPOCHS, batch_size=BATCH_SIZE, prev_model="lenet_cumul2_resized.h5")
